...
from exkaldi.utils.utils import WrongOperation, WrongDataFormat, KaldiProcessError, UnsupportedType
from exkaldi.utils.utils import run_shell_command, make_dependent_dirs, type_name, check_config
from exkaldi.core.achivements import BytesAchievement, Transcription
