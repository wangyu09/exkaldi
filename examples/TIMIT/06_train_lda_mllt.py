...
def main():
    ...
    args.add("--mlltIter", abbreviation="-i", dtype=int, default=[2,4,6,12], discription="the iteration to estimate mllt matrix.")
    ...
    GMM_decode_mfcc_and_score(
                outDir=os.path.join(args.expDir,"train_lda_mllt","decode"), 
                hmm=model,
